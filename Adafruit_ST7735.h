...
class Adafruit_ST7735 : public Adafruit_ST77xx {
  uint8_t tabcolor = 0;
public:
    inline Adafruit_ST7735(int8_t CS, int8_t RS, int8_t RST)                            : Adafruit_ST77xx(ST7735_TFTWIDTH_80, ST7735_TFTHEIGHT_160, CS, RS, RST) {}
    inline Adafruit_ST7735(int8_t CS, int8_t RS, int8_t MOSI, int8_t SCLK, int8_t RST)  : Adafruit_ST77xx(ST7735_TFTWIDTH_80, ST7735_TFTHEIGHT_160, CS, RS, MOSI, SCLK, RST) {}
#ifndef ESP8266
